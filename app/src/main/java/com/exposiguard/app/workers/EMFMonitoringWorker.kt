    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            if (monitorWifi) {
                ...
                }.onFailure { e -> android.util.Log.w("EMFMonitoringWorker", context.getString(R.string.log_wifi_sampling_failed, e.message)) }
            }
            ...
            if (monitorEmf || monitorHome) {
                ...
                }.onFailure { e -> android.util.Log.w("EMFMonitoringWorker", context.getString(R.string.log_sar_sampling_failed, e.message)) }
            }
            ...
            android.util.Log.e("EMFMonitoringWorker", context.getString(R.string.log_emf_monitoring_failed), e)
            Result.failure()
        }
    }
}
