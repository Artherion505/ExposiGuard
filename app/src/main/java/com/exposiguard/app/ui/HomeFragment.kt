...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Ko-fi support button - Open Ko-fi page in browser
        try {
            binding.btnKofiSupport.setOnClickListener {
                try {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://ko-fi.com/davidpolvo"))
